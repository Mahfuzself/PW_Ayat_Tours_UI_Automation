...
test("Verify Mens Retreat page booking",async({page,mensretreatpage}) =>{
    ...
    await mensretreatpage.VerifyCardNumberLabel()
    await mensretreatpage.inputCardNumber()
    await mensretreatpage.inputCardExpDate()
    await mensretreatpage.inputSecurity()
    await mensretreatpage.selectCountry()
    await mensretreatpage.inputZIP()
    await mensretreatpage.ClickPayButton()
